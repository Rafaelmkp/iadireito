...
$(document).ready(function () {
  ...
  $(add_button).click(function (e) {
    ...
    if (x < max_fields) {
      ...
      $(wrapper).append(
        '<div><label for="advautor">Advogado:</label><input type="text" name="mytext[]"><br><br> <label for="oabadvautor">OAB:</label> <input type="text name=oabadvautor"><br><br><label for="estoabautor">Estado:</label> <select name="estoabautor" id="estoabautor"><option value="branco"></option><option value="AC">AC</option><option value="AL">AL</option><option value="AP">AP</option>/<option value="AM">AM</option><option value="BA">BA</option><option value="CE">CE</option><option value="DF">DF</option><option value="ES">ES</option><option value="GO">GO</option><option value="MA">MA</option><option value="MT">MT</option><option value="MS">MS</option><option value="MG">MG</option><option value="PA">PA</option><option value="PB">PB</option><option value="PR">PR</option><option value="PE">PE</option><option value="PI">PI</option><option value="RJ">RJ</option><option value="RN">RN</option><option value="RS">RS</option><option value="RO">RO</option><option value="RR">RR</option><option value="SC">SC</option><option value="SP">SP</option><option value="SE">SE</option><option value="TO">TO</option></select><a href="#" class="remove_field">Excluir</a></div>'
      ); //add input box
    }
  });
...
$(document).ready(function () {
  ...
  $("#addAutor").click(function () {
    if (counter > 15) {
      alert("São permitidos somente 15 registros!");
      return false;
    }
  ...
  $("#removeAutor").click(function () {
    if (counter <= 2) {
      alert("Não há como remover campo! Somente editar.");
      return false;
    }
...
$(document).ready(function () {
  ...
  $("#addReu").click(function () {
    if (counter > 15) {
      alert("São permitidos somente 15 registros!");
      return false;
    }

    var newTextDiv = $(document.createElement("div")).attr(
      "id",
      "TextDiv" + counter
    );
