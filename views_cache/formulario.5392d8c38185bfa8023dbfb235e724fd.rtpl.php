    ...
    <form action="/submit-summons" method="post" autocomplete="off">
      ...
      <div class="parent">
        ...
        <div class="conteudo">
          ...
          <br><br>
          <textarea id="conteudo" name="conteudo" rows="45" cols="50" align"center"></textarea>
        </div>
        ...
        <div class="dados">
          ...
          <br><br>
          <label for="n_processo">Número CNJ:</label>
          <input type="text" id="n_cnj" name="n_cnj" size="20" maxlength="20">
          <br><br>
          ...
          <select name="natureza" id="natureza">
            ...
            <option value="trabalhista">Bancária</option>
            <option value="civil">Civil</option>
            <option value="trabalhista">Empresarial</option>
            <option value="trabalhista">Família</option>
          ...
          <div class="input_fields_wrapB">
            <button class="add_field_buttonB">Adicionar novo advogado do autor</button>
            <br><br>
            <div><label for="advautor">Advogado:</label><input type="text" name="advautor[]"><br><br>
              <label for="oabadvautor">OAB:</label> <input type="text" name="oabadvautor[]"><br><br>
            </div>
          </div>
          ...
          <div class="input_fields_wrapC">
            ...
            <br><br>
            <label for="reu">Réu:</label><input type="text" name="reu[]"><br><br>
          </div>
  
          <div class="input_fields_wrapD">
            <button class="add_field_buttonD">Adicionar novo advogado do réu</button>
            <br><br>
            <div><label for="advreu">Advogado:</label><input type="text" name="advreu[]"><br><br>
              <label for="oabadvreu">OAB:</label> <input type="text" name="oabadvreu[]"><br><br>
            </div>
          </div>
          ...
          <select name="recurso" id="recurso">
            ...
            <option value="interlocutoria">Descisão Interlocutória</option>
          ...
          <select name="recurso" id="recurso">
            ...
            <option value="agr_recesp">Agravo em Recurso Especial</option>
            <option value="agr_recextr">Agravo em Recurso Extraordinário</option>
          ...
          <input type="date" id="datepicker" name="inicio" size="8" maxlength="10"> <br><br>
          <label for="dias_prazo">Prazo:</label>
          <input type="text" id="dias_prazo" name="dias_prazo" size="2" maxlength="2">
          ...
          <input type="date" id="datepicker" name="fim" size="8" maxlength="10"> <br><br>
          <label for="custas">Há custas?</label>
          <input type="radio" onclick="show1();" name="yesno" id="yesCheck" value="sim">Sim
          <input type="radio" onclick="show2();" name="yesno" id="noCheck" value="nao">Não
          <br><br>
